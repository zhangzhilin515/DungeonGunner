...
public class Enemy : MonoBehaviour
{
    ...
    private void SetEnemyStartingWeapon()
    {
        ...
        {
            Weapon weapon = new Weapon() { weaponDetails = enemyDetails.enemyWeapon, weaponReloadTimer = 0f, weaponClipRemainAmmo = enemyDetails.enemyWeapon.weaponClipAmmoCapacity, weaponRemainAmmo = enemyDetails.enemyWeapon.weaponAmmoCapacity, isWeaponReload = false };
