...
public class CharacterSelectorUI : MonoBehaviour
{
    ...
    {
        HelpUtilities.ValidateCheckNullValue(this, nameof(characterSelector), characterSelector);
        HelpUtilities.ValidateCheckNullValue(this, nameof(playerNameInput), playerNameInput);
    }
#endif
}