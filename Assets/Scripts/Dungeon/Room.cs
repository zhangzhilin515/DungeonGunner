...
public class Room
{
    ...
    public List<RoomEnemySpawnParameters> roomEnemySpawnSpawnParametersList;
    ...
    {
        foreach(RoomEnemySpawnParameters roomEnemySpawnParameters in roomEnemySpawnSpawnParametersList)
        {
